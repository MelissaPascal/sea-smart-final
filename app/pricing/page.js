        ...
        <div style={{ 
          ...
          <div style={cardStyle}>
            ...
            <div style={{ textAlign: 'left', fontSize: '0.9rem', color: '#666' }}>
              <div style={{ margin: '0.5rem 0' }}>✅ Help your child succeed at home</div>
              <div style={{ margin: '0.5rem 0' }}>✅ Track progress with detailed worksheets</div>
              <div style={{ margin: '0.5rem 0' }}>✅ Cultural content they'll actually relate to</div>
              <div style={{ margin: '0.5rem 0' }}>✅ No more expensive tutoring sessions</div>
            </div>
          </div>
          ...
          <div style={cardStyle}>
            ...
            <div style={{ textAlign: 'left', fontSize: '0.9rem', color: '#666' }}>
              <div style={{ margin: '0.5rem 0' }}>✅ Classroom-ready materials in seconds</div>
              <div style={{ margin: '0.5rem 0' }}>✅ SEA-aligned curriculum support</div>
              <div style={{ margin: '0.5rem 0' }}>✅ Differentiated learning for all students</div>
              <div style={{ margin: '0.5rem 0' }}>✅ Save hours on lesson planning</div>
            </div>
          </div>
          ...
          <div style={cardStyle}>
            ...
            <div style={{ textAlign: 'left', fontSize: '0.9rem', color: '#666' }}>
              <div style={{ margin: '0.5rem 0' }}>✅ Professional-grade practice materials</div>
              <div style={{ margin: '0.5rem 0' }}>✅ Multiple subjects and grade levels</div>
              <div style={{ margin: '0.5rem 0' }}>✅ Impress parents with quality resources</div>
              <div style={{ margin: '0.5rem 0' }}>✅ Scale your tutoring business</div>
            </div>
          </div>
        </div>
